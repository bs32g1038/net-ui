        ...
        <section class="section section-navigation">
            <div class="container flex flex-around">
                <div class="navigation-panel">
                    ...
                    <div class="desc">
                        Understand the design guidelines, makes design and prototype more simple and accessible for all
                        project members.
                    </div>
                    <div class="btn-readmore">
                        <router-link :to="{ name: 'Guide-en' }"
                ...
                <div class="navigation-panel">
                    ...
                    <div class="btn-readmore">
                        <router-link :to="{ name: 'Resource-en' }"
                            >View Details <i class="icon icon-chevron-right"></i
                        ></router-link>
                    </div>
                </div>
