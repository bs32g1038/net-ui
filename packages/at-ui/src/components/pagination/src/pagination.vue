<template>
    ...
    >
        ...
        <template v-else>
            <li
                class="at-pagination__item"
                :class="{ 'at-pagination__item--active': currentPage === 1 }"
                @click="changePage(1)"
            >
                1
            </li>
            ...
            <li class="at-pagination__item" v-if="currentPage > 3" @click="changePage(currentPage - 2)">
                {{ currentPage - 2 }}
            </li>
            <li class="at-pagination__item" v-if="currentPage > 2" @click="changePage(currentPage - 1)">
                {{ currentPage - 1 }}
            </li>
            <li
                class="at-pagination__item at-pagination__item--active"
                v-if="currentPage !== 1 && currentPage !== totalPage"
            >
                {{ currentPage }}
            </li>
            <li class="at-pagination__item" v-if="currentPage < totalPage - 1" @click="changePage(currentPage + 1)">
                {{ currentPage + 1 }}
            </li>
            <li class="at-pagination__item" v-if="currentPage < totalPage - 2" @click="changePage(currentPage + 2)">
                {{ currentPage + 2 }}
            </li>
            <li
            ...
            <li
                class="at-pagination__item"
                v-if="totalPage > 1"
                :class="{ 'at-pagination__item--active': currentPage === totalPage }"
        ...
        <div v-if="showSizer" class="at-pagination__sizer">
            <at-select v-model="currentPageSize" :size="size" @on-change="changeSize">
                <at-option v-for="item in pageSizeOpts" :key="item" :value="item">{{
