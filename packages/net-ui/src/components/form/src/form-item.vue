<template>
    <div
        :class="[
            'net-form-item',
            {
                ['net-form-item--required']: this.required || this.isRequired,
                ['net-form-item--error']: this.validateState === 'error',
                ['net-form-item--validating']: this.validateState === 'validating',
            },
        ]"
    >
        <label class="net-form-item__label" :style="labelStyles" v-if="label">
            <slot name="label">{{ label }}</slot>
        </label>
        <div class="net-form-item__content" :style="contentStyles">
            <slot></slot>
            <transition name="fade">
                <div
                    class="net-form-item__error-tip"
