<template>
    <div
        class="net-progress"
        :class="[
            type ? `net-progress--${type}` : 'net-progress--bar',
            currentStatus ? `net-progress--${currentStatus}` : '',
        ]"
    >
        <!-- S 环形进度条 -->
        <div class="net-progress-circle" v-if="type === 'circle'"></div>
        <!-- E 环形进度条 -->

        <!-- S 条状进度条 -->
        <div class="net-progress-bar" v-else>
            <div class="net-progress-bar__wraper" :style="barStyle">
                <div class="net-progress-bar__inner" :style="{ width: percent + '%' }"></div>
            </div>
        </div>
        <div class="net-progress__text">
