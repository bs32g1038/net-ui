<template>
    <div
        class="net-input-number"
        :class="[
            size ? `net-input-number--${size}` : '',
            {
                'net-input-number--disabled': disabled,
            },
        ]"
    >
        <!-- S input -->
        <div class="net-input-number__input">
            <input
                type="number"
                class="net-input-number__original"
                :value="currentValue"
                :name="name"
                :disabled="disabled"
                :readonly="readonly"
        ...
        <!-- S handle button -->
        <div class="net-input-number__handler">
            <span
                class="net-input-number__up"
                :class="{
                    'net-input-number__up--disabled': upDisabled,
                }"
                @click="increaseNum"
            >
            ...
            <span
                class="net-input-number__down"
                :class="{
                    'net-input-number__down--disabled': downDisabled,
                }"
                @click="decreaseNum"
            >
