<template>
    <div class="net-slider">
        <!-- S InputNumber -->
        <net-input-number
            class="net-slider__input"
            v-model="inputValue"
            v-show="false"
            :step="step"
            :disabled="disabled"
        ...
        <!-- S slider track -->
        <div
            class="net-slider__track"
            :class="{
                'net-slider--disabled': disabled,
            }"
            @click="onSliderClick"
            ref="slider"
        >
            <div class="net-slider__bar" :style="{ width: currentPosition }"></div>

            <!-- S tooltip and dot -->
            <div
                class="net-slider__dot-wrapper"
                :class="{
                    'net-slider__dot-wrapper--hover': isHover,
                    'net-slider__dot-wrapper--drag': isDrag,
                }"
            ...
            >
                <net-tooltip placement="top" trigger="click" content="Top value" ref="tooltip">
                    <div
                        class="net-slider__dot"
                        :class="{
                            'net-slider__dot--hover': isHover,
                            'net-slider__dot--drag': isDrag,
                        }"
                    ></div>
...
<script>
import AtTooltip from 'net-ui/src/components/tooltip';
import AtInputNumber from 'net-ui/src/components/input-number';
