        ...
        <div class="container">
            ...
            <div class="btn-container">
                <div class="btn btn-begin">
                    <router-link :to="{ name: 'Introduction-zh' }">开始使用</router-link>
                </div>
        ...
        <div class="container flex flex-around">
            <div class="navigation-panel">
                ...
                <div class="btn-readmore">
                    <router-link :to="{ name: 'Guide' }">查看详情 <i class="icon icon-chevron-right"></i></router-link>
                </div>
            </div>
            <div class="navigation-panel">
                <div class="icon-cnt">
                ...
                <div class="btn-readmore">
                    <router-link :to="{ name: 'Docs' }">查看详情 <i class="icon icon-chevron-right"></i></router-link>
                </div>
            </div>
            <div class="navigation-panel">
                <div class="icon-cnt">
