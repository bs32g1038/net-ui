<template>
    <div class="wrapper">
        <div class="wrapper">
            <app-header :collapse="false"></app-header>
                ...
                <div class="container">
                    ...
                    <div class="btn-container">
                        <div class="btn btn-begin">
                            <nuxt-link to="/en/docs/introduction">GET STARTED</nuxt-link>
                        </div>
            ...
            <section class="section section-navigation">
                <div class="container flex flex-around">
                    <div class="navigation-panel">
                        ...
                        <div class="desc">
                            Understand the design guidelines, makes design and prototype more simple and accessible for
                            all project members.
                        </div>
                        <div class="btn-readmore">
                            <nuxt-link to="/en/guide">View Details <i class="icon icon-chevron-right"></i></nuxt-link>
                        </div>
                    </div>
                    <div class="navigation-panel">
                        <div class="icon-cnt">
                        ...
                        <div class="desc">
                            Base on Vue.js, experience interaction details by strolling through component demos. Use the
                            components singleton or global is free.
                        </div>
                        <div class="btn-readmore">
                            <router-link to="/en/docs">
                                View Details <i class="icon icon-chevron-right"> </i>
                            </router-link>
                        </div>
                    </div>
                    <div class="navigation-panel">
                        ...
                        <div class="desc">
                            Provide the design resources, product managers can make prototype more simple and efficient.
                            Save time and improve work efficiency.
                        </div>
                        <div class="btn-readmore">
                            <nuxt-link to="/en/resource"
                                >View Details <i class="icon icon-chevron-right"></i
                            ></nuxt-link>
                        </div>
                    </div>
